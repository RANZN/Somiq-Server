...
import com.ranjan.data.auth.service.JwtAuthTokenService
import com.ranjan.data.auth.service.JwtRefreshTokenService
import com.ranjan.data.auth.service.JwtSignupTokenService
...
val dataModule = module {
    ...
    singleOf(::JwtAuthTokenService) { bind<AuthTokenProvider>() }
    singleOf(::JwtRefreshTokenService) { bind<RefreshTokenService>() }
    singleOf(::JwtSignupTokenService) { bind<SignupTokenService>() }
